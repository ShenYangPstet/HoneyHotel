...
public class DESUtils {
	...
	public static void main(String[] args) throws Exception {
		String key = "studio20";
		String jiami = "studio20,wuhan,CC97-CC92,2024-04-02,10000,50,2024-05-16";


		System.out.println("加密数据:" + jiami);
		String a = toHexString(encrypt(jiami,key));
		System.out.println("加密后的数据为:" + a);
		String b =decrypt("00c34200299b60bea84c77fb70d6af7c426654749d09dbb9b611f453b6bdad9f425525c0639e077768058417ea6db4b8ac36b1402f901131",key);
