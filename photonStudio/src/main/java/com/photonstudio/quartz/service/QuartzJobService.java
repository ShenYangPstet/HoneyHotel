package com.photonstudio.quartz.service;
...
QuartzJobService {
	...
	public String findState(JobKey jobKeys) {
		// TODO Auto-generated method stub
		TriggerKey triggerKey = TriggerKey.triggerKey(jobKeys.getName(), jobKeys.getGroup());
		String name="";
		 try {
